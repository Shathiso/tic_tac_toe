...
describe('selectPlayerSymbol', () => {
  it('Sets the player symbol', () => {
    expect(newGame.selectPlayerSymbol("X")).toBeFunction();
  });
});
...
describe('selectCell', () => {
  it('Selects a cell on the board', () => {
    expect(newGame.selectCell("X")).toBeFunction();
  });
});
...
describe('findCell', () => {
  it('Finds a cell', () => {
    expect(newGame.findCell("X")).toBeFunction();
  });
});
...
describe('checkWinner', () => {
  it('Checks for a winner', () => {
    expect(newGame.checkWinner("X")).toBeFunction();
  });
});
...
describe('winningPermutations', () => {
  it('Returns winning permutations', () => {
    expect(newGame.winningPermutations()).toBeFunction().toBeArray();
  });
});
...
describe('computersPlay', () => {
  it('Simulates the computers turn', () => {
    expect(selectPlayerSymbol("X")).toBeFunction();
  });
});
